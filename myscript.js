$(".start").click(function () {
  ...
  fire_modal(
    ...
    "Because I love you, I made this bouquet for the occasion of October 20"
  );
});
...
$(".mixer").click(function () {
  ...
  if (mixtimes == 6) {
    $(".stage2").fadeOut();
    fire_modal(
      "phachoatranhthanhcong.png",
      "Draw successful!",
      "Congratulations, Now the next step is to color it to make the picture more vivid."
    );
  }
});
...
$(".oven").droppable({
  drop: function (event, ui) {
    ...
    fire_modal(
      "buctranh.png",
      "Add color successfull!",
      "Yes!Now You can press continue and enjoy the results You made hihi!."
    );
  },
});
